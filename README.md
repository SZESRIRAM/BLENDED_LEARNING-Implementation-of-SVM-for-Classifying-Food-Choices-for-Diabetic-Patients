...
## Algorithm
1. Import the required libraries, load the dataset, and select relevant features and target variable.<br/>
2. Split the dataset into training and testing sets and perform feature scaling using StandardScaler.<br/>
3. Create the SVM model, apply GridSearchCV for hyperparameter tuning, and train the model.<br/>
